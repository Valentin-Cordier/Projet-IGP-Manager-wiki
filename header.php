  ...
  <div class="main">
    <nav id="nav">
      ...
      <ul class="ul">
        ...
        <li class="li"><a href="debutant.php">Guide débutant</a></li>
         <li class="dropdown2">
          <a href="javascript:void(0)" class="dropbtn2">Guide expérimenté</a>
          <div class="dropdown-content2">
            <a href="gestion.php">La gestion et stratégie de course</a>
            <a href="conception.php">La conception</a>
            <a href="Pilote.php">Pilote</a>
            <a href="pousse.php">Gestion de poussé</a>
          </div></li>
        ...
        <li class="li"><a href="connexion.php"><i class="fas fa-sign-in-alt"></i></a></li>
